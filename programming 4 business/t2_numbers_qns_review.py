...
#7. What is the value of an integer division of `num_2` by `num_4`? # 2.0
print(num_2//num_4)
#8. What is the  remainder of `num_2` by `num_4`? 0.5
print( num_2 % num_4)

#9. What is  the value of 4 raised to the power of 5? 1024
print(4**5)
#10. Multiply `num_2` with `num_4` before adding the value to `num_3` in a single 5225.5
# arithmetic expression.
print(num_2*num_4+float(num_3))

#11. Add `num_2` and `num_4` before multiplying the value by `num_3` in a single 30175.25
# arithemtic expression.
print((num_2+num_4)*float(num_3))
#12. Round 2.02454 to 2 decimal places. 2.02
print(round(2.02454,2))

#13. Round 1000.40 to an integer. 1000
print(round(1000.40))

#14. What is the value of 4 raised to the power of 5 using the pow() function? 1024
print(pow(4,5))
